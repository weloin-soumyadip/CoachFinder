/// Owner change-password screen, wired to `POST /api/owners/me/password` via
/// [ownerProfileControllerProvider]. The data layer persists the re-issued
/// tokens so the session survives the server-side revocation. Mirrors the
/// student change-password screen (owner orange accent).
library;
...
/// Owner change-password form: current + new + confirm, validated client-side
/// and submitted to the backend. On success snackbars + pops; on failure
...
/// A labelled obscured password field.
