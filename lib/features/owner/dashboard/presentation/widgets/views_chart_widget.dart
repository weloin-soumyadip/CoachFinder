...
/// An embossed neomorphic card charting daily profile views for the week. The
/// bars are painted by [_BarsPainter] (a `CustomPainter`, so no chart
/// dependency is added); the tallest day is highlighted in the owner accent and
/// annotated with its value. Day labels sit in a matching column grid beneath
/// the bars.
