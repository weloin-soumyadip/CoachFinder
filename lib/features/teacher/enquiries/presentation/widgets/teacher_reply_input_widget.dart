/// Multi-line reply input pinned at the bottom of the teacher enquiry detail.
library;
...
class TeacherReplyInputWidget extends HookWidget {
  const TeacherReplyInputWidget({super.key, required this.onSend});
